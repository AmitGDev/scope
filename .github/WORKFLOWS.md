...
2. Setup C++ dependencies (e.g. Boost, spdlog)
3. Setup C++ environment (e.g. compilers, LLVM, Ninja)
4. Validate code formatting (clang-format)
5. Configure CMake with Ninja generator
6. Build project with C++23 standard
7. Verify compilation database
8. Run clang-tidy with warnings-as-errors
9. Optional: CodeQL security analysis
